...
public class RestaurantSeederService {
    ...
    public ResponseModel init(){
        ...
        AddressEntity addressEntity = addressDao.save(new AddressEntity( null,"Italy", null, "123", "via malfamata", 5d, "piano terra", BigDecimal.valueOf(45.0), BigDecimal.valueOf(70)));
